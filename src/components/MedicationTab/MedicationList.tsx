...
import { Pill, AlertTriangle, Heart, Clock, FileText, X } from 'lucide-react';
...
export function MedicationList({ medications, onDelete, onShowInfo, category }: MedicationListProps) {
  // Filter medications by category, handling case-insensitively and safely
  ...
  if (filteredMeds.length === 0) {
    return (
      <div className="text-center py-8 text-gray-500">
        No {category === 'otc' ? 'over-the-counter medications' : 'prescription medications'} added yet.
      </div>
    );
  }
