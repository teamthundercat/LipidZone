            ...
            <div className="flex items-start gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {activeTab === 'photo' 
                    ? 'Capture your OTC medication container'
                    : 'Share a clear image of the OTC medication label'
                  }
                </p>
              </div>
            </div>
